...
class GetData:
    def __init__(self):
        ...
        self.category_url_list_test = [
            'https://www.youpin898.com/market/csgo?gameId=730&weapon=weapon_knife_survival_bowie',
    ...
    def get_category_info_url(self):
        ...
        for one_category_url in self.category_url_list:
            ...
            try:
                ...
                try:
                    goods_lease_cnt = len(
                        onegoods_category_lease_html.xpath(
                            '//*[@id="__layout"]/div/div[3]/div[1]/div/div[2]/div[4]/div[2]/div[1]')[0])
                except Exception, e:
                    print Exception, e
                ...
                if goods_lease_cnt == 0:
                    ...
                    for i in range(1, goods_lease_cnt):
                        try:
                            xpath = '//*[@id="__layout"]/div/div[3]/div[1]/div/div[2]/div[4]/div[2]/div[1]/div[' + str(
                                i) + ']/span/div[2]/div[1]/text()'
            ...
            try:
                ...
                for i in range(0, len(label_list[0]) - 1):
                    ...
                    if lease_cnt > 0:
                        ...
                        if lease_cnt >= 15:
                            ...
                            time.sleep(2)
                        goods_items_html = etree.HTML(BeautifulSoup(driver.page_source, "html.parser").decode('utf-8'))
                        leasesale_div_list = goods_items_html.xpath(
                            '//*[@id="__layout"]/div/div[3]/div[1]/div[9]/ul[1]')
                    ...
                    if lease_cnt > 0 or lease_cnt > 0:
                        driver.find_element_by_xpath(
                            '//*[@id="__layout"]/div/div[3]/div[1]/div[4]/div/div[1]/div/div/div/div/div[1]/div[4]').click()
                ...
                for i in range(0, len(label_list[0]) - 1):
                    ...
                    if sale_cnt > 0:
                        ...
                        ac = ActionChains(driver)
                        ac.click(driver.find_element_by_xpath(
                            '//*[@id="__layout"]/div/div[3]/div[1]/div[4]/div[1]/div[1]/div/div/div/div/div[1]/div[2]'))\
                            .perform()
                        if sale_cnt >= 15:
                            driver.execute_script(js)
                            time.sleep(5)
